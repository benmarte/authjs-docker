...
export default function SessionData({ session }: { session: Session | null }) {
  if (session?.user) {
    return (
      <div className="flex flex-col gap-4 p-4 w-full bg-white-100 rounded-md">
        <h2 className="text-xl font-bold text-white">Current Session Data</h2>
  ...
  return (
    <p className="p-4 w-full bg-gray-100 rounded-md text-black">
